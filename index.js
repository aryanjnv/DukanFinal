function handleFormSubmit(event) {
  ...
  axios
    .post(
      "https://crudcrud.com/api/be7d21bfbff94dfea6a3314beb77df2b/item",
      itemDetails
    )
  ...
  buyButton1.addEventListener("click", function () {
    ...
    axios
        ...
        .then(function (response) {
            ...
            axios
                .delete(`https://crudcrud.com/api/be7d21bfbff94dfea6a3314beb77df2b/item/${createdItemId}`)
...
function initUI() {
  axios
    .get("https://crudcrud.com/api/be7d21bfbff94dfea6a3314beb77df2b/item")
    .then(function (response) {
...
function buy(itemId, no, listItem) {
  axios
    .get(
      `https://crudcrud.com/api/be7d21bfbff94dfea6a3314beb77df2b/item/${itemId}`
    )
    .then(function (response) {
